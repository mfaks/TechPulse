      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        <div>
          <div className="flex justify-center items-center gap-8">
            <Card className="w-64 overflow-hidden rounded-xl shadow-lg transition-all duration-300 hover:shadow-blue-200/50 backdrop-blur-sm bg-gradient-to-br from-white/90 to-blue-50/90 border-2 border-blue-100">
              <CardHeader className="bg-gradient-to-br from-blue-950 to-blue-900 p-4">
                <CardTitle className="text-center text-white text-lg">Custom Tech News</CardTitle>
              </CardHeader>
              <CardContent className="p-4">
                <img 
                  src="https://placecats.com/300/201" 
                  alt="News" 
                  className="rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
                />
              </CardContent>
            </Card>
            <Card className="max-w-4xl overflow-hidden rounded-xl shadow-2xl transition-all duration-300 ease-in-out hover:shadow-blue-200/50 backdrop-blur-sm bg-gradient-to-br from-white/90 to-blue-50/90 border-2 border-blue-100">
            ...
            <Card className="w-64 overflow-hidden rounded-xl shadow-lg transition-all duration-300 hover:shadow-blue-200/50 backdrop-blur-sm bg-gradient-to-br from-white/90 to-blue-50/90 border-2 border-blue-100">
              <CardHeader className="bg-gradient-to-br from-blue-950 to-blue-900 p-4">
                <CardTitle className="text-center text-white text-lg">Learn and Ask Questions</CardTitle>
              </CardHeader>
              <CardContent className="p-4">
                <img 
                  src="https://placecats.com/300/201" 
